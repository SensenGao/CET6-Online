...
<%--    <button type="button1" class="btn btn-primary" onclick="queryData1()">删除</button>--%>
</form>
...
<script type="text/javascript">
    function queryData(){
        location.href="${path}/CET6/login.do?userId="+$("#userid").val()+"&&userPassword="+$("#userpassword").val();
    ...
    <%--    &lt;%&ndash;location.href="${path}/CET6/view.do?userId="+$("#userid").val()+"&&userPassword="+$("#userpassword").val();&ndash;%&gt;--%>
    <%--}--%>
</script>
</body>
</html>
