...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <span class="navbar-text" style="font-size: 20px; text-align: center; line-height: 50px; margin-left: 1040px;">欢迎，gaosensen学生</span>
    </div>
</nav>
...
<div class="manageContainer">
    <div class="clock">
        <!-- 倒计时计时器 -->
        <h2 style="font-size: 37px;font-weight: 600;color: #AA0000">剩余时间：<span id="countdown"></span></h2>
    </div>
    ...
    <div class="questionContainer">
        <form id="questionDetails">
            ...
            <div class="form-group" style="font-size: 25px">
                ...
                <textarea class="form-control"  style="font-size: 20px" name="answer" rows="8">${subQuetion.getSubjective_Answer()}</textarea>
            </div>
            <div>   </div>
            <div>   </div>
        </form>
...
<%--                <br>--%>
            ...
            <div class="form-group" style="font-size: 25px">
                <p><input class="inputClass" type="radio" value="A" style="width: 20px;height: 20px"> A.I have been watching a movie last night.</p>
                <p><input class="inputClass" type="radio" value="A" style="width: 20px;height: 20px"> B.She has eat dinner an hour ago.</p>
                <p><input class="inputClass" type="radio" value="A" style="width: 20px;height: 20px"> C.They have visited Paris last summer.</p>
                <p><input class="inputClass" type="radio" value="A" style="width: 20px;height: 20px"> D.We have lived in this city for five years.</p>
            </div>
            <div>   </div>
            <div>   </div>
        </form>
