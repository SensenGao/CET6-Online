...
<div class="container">
    <h1 style="color: #428bca ;font-size: 45px; font-weight:600;">
        主观题录入
        <br><br>
    </h1>
    ...
    <form>
        <div class="form-group">
            <label for="question" style="color: #428bca ;font-size: 30px; font-weight:600;">
                题干录入：
            </label>
        ...
        <button type="submit" class="btn btn-primary" onclick="insertData()"
                style="color: #000000 ;font-size: 30px; font-weight:600;">
            提交录入信息
        </button>
    </form>
</div>
