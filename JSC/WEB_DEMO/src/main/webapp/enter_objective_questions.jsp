...
<div class="container">
    <h1 style="color: #428bca ;font-size: 35px; font-weight:600;">
        客观题录入
    </h1>

    <form>
        <div class="form-group">
            <label for="question" style="color: #428bca ;font-size: 25px; font-weight:600;">
                题干录入：
            </label>
            <textarea class="form-control" id="question" name="question" rows="4"
                      style="font-size: 20px; font-weight:600;"></textarea>
        </div>
        ...
        <div class="form-group">
            <label style="font-size: 20px; font-weight:600;">正确答案:</label>
            <div class="form-check">
                ...
                <label class="form-check-label" for="optionA_radio"
                       style="font-size: 20px; font-weight:600;">选项 A</label>
            </div>
            <div class="form-check">
                ...
                <label class="form-check-label" for="optionB_radio"
                       style="font-size: 20px; font-weight:600;">选项 B</label>
            </div>
            <div class="form-check">
